...
export default class PathfinderVisualizer extends Component {
  ...
  handleMouseDown(row, col) {
    if (this.state.topMessage !== "Hack UNT") return;
  ...
  visualizeDijkstra() {
    this.setState({ topMessage: "Happy Hacking!" });
  ...
  animateDijkstra(visitedNodesInOrder, nodesInShortestPathOrder) {
    for (let i = 1; i <= visitedNodesInOrder.length; i++) {
      ...
      if (i === visitedNodesInOrder.length) {
        setTimeout(() => {
          this.setState({ topMessage: "Calculated Shortest Path" });
    ...
    let textBox = (
      <div className="textBox">
        <div className="weightContainer">
          <label htmlFor="quantity">Toggle or Set Tortoise </label>
        ...
        <div className="startPointContainer">
          <label htmlFor="point">Hare Location :</label>
          <input
            type="number"
            name="point"
            id="start_row"
        ...
        <div className="endPointContainer">
          <label htmlFor="point">Carrot Location :</label>
          <input
            type="number"
            name="point"
            id="end_row"
    ...
    return (
      <div className="pathfindingVisualizer">
        <div className="container">
          ...
          <p>
            Find the shortest path to your destination!{" "}
